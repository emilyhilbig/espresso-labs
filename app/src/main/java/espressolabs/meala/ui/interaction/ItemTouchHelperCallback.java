...
public class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public ItemTouchHelperCallback(Context context, OnSwipeListener listener) {
        ...
        leftColor = ContextCompat.getColor(context, R.color.green);
        leftIcon = Utils.convertDrawableToBitmap(ContextCompat.getDrawable(context, R.drawable.ic_check_white_24dp));
        rightColor = ContextCompat.getColor(context, R.color.red);
        rightIcon = Utils.convertDrawableToBitmap(ContextCompat.getDrawable(context, R.drawable.ic_delete_white_24dp));
    }
