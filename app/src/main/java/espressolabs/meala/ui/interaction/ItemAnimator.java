...
import espressolabs.meala.animation.BackgroundColorAnimator;
import espressolabs.meala.animation.ColorAnimator;
import espressolabs.meala.animation.LayoutParamHeightAnimator;
...
public class ItemAnimator extends DefaultItemAnimator {
    ...
    public ItemAnimator(Context context, onAnimationEndListener listener) {
        this.deletedBgColor = ContextCompat.getColor(context, R.color.red);
        this.archivedBgColor = ContextCompat.getColor(context, R.color.green);
        this.targetTextColor = ContextCompat.getColor(context, R.color.white);
    ...
    private ColorAnimator createTextColorAnimator(final TextView view, int targetColor) {
        ...
        anim.addUpdateListener(valueAnimator -> view.setTextColor((int) valueAnimator.getAnimatedValue()));
